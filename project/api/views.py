...
#### routes ####
################
# vall from browser localhost:5000/api/v1/tasks to view all tasks in json format
# for all tasks
...
def task(task_id):
    ...
    if result:
        ...
        result_json = {'error': 'Element does not exist'}
        code = 404
    return make_response(jsonify(result_json), code)
